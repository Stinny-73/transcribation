...
def summarize_file(filepath):
    try:
        ...
        if len(text) > 50000:  # Если текст очень большой
            print("Внимание: текст большой, суммаризация может занять время")
        
        # Формируем запрос
        prompt = f'''Напиши текст суммаризирующий исходный, сократи исходный текст на 40-60%, должен быть написан на том же языке, что и исходный текст.
